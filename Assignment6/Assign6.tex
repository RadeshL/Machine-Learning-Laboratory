...
\textbf{Experiment Title}     & Bagging, Boosting, and Stacked Ensemble Models%
  \footnote{\textbf{GitHub Repository:} \url{https://github.com/username/repository}} \\ \hline
\textbf{Degree \& Branch}     & B.E. Computer Science \& Engineering \\ \hline
\textbf{Semester}             & V \\ \hline
\textbf{Subject Code \& Name} & ICS1512 -- Machine Learning Laboratory \\ \hline
...
\textbf{Submission Date}      & 31-08-2026 \\ \hline
\textbf{Github Repo}      & \url{ https://github.com/RadeshL/Machine-Learning-Laboratory/blob/main/MLassign6.ipynb}\\ \hline
\end{tabular}
\vspace{1cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.52\linewidth]{e7_fig1_class}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\linewidth]{e7_fig2_corr}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\linewidth]{e7_fig3_cv}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.52\linewidth]{e7_fig4_bag_cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.52\linewidth]{e7_fig5_ada_cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.52\linewidth]{e7_fig6_gb_cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.52\linewidth]{e7_fig7_stk_cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.68\linewidth]{e7_fig8_roc}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\linewidth]{e7_fig9_metrics}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\linewidth]{e7_fig10_fi}
